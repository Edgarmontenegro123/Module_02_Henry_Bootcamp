...
// Seleccionamos el <span> por su id
let appCreadaPor = document.getElementById('createdBy');
// let appCreadaPor = document.querySelector("#createdBy");

// Agregamos el nombre al final del texto actual
appCreadaPor.innerHTML = `${appCreadaPor.innerHTML}  Edgar`

// Creamos un elemento <span> que me va a servir para borrar todo
let garbage = document.createElement('span');
// Agregamos a nuestro boton la funcionalidad de borrar
garbage.addEventListener('click', deleteAll);
// Creamos una imagen donde va a ir nuestro boton para borrar todo 
let icon = document.createElement('img');
// Agregamos la imagen del boton para borrar todo
icon.setAttribute('src', './delete_black_24dp.svg');
// Agregamos el ícono como hijo de nuestro botón para eliminar todo
garbage.appendChild(icon);
// Creamos el div contenedor 
let container = document.getElementById('inputContainer');
//let container = document.querySelector('#inputContainer');
// Agregamos nuestro botón garbage como hijo de nuestro contenedor
container.appendChild(garbage);
...
function buildToDos(toDos){
  ...
  // let newArray = toDos.map(function(elem, index){
...
// Tu código acá:
let elemento = document.getElementById('addButton');
// let elemento = document.querySelector('#addButton');
...
function completeToDo(event){
  ...
  // Tu código acá:
   let toDoClick = toDoItems[index];
  toDoClick.completeToDo();
  displayToDos();
}
