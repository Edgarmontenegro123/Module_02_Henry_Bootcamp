// Método antes de ECMAScript 6
// let EvEm = require('./event-emitter.js');
// let whiteboard = new EvEm();

import {EventEmitter} from './event-emitter.js';
export let whiteboard = new EventEmitter();

  // window.whiteboard = new window.EventEmitter(); // Exponiendo whiteboard y a su vez 
  // requiriendo EventEmitter
